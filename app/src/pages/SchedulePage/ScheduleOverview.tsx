...
export default function ScheduleOverview({
  ...
  const handleToggleSchedule = async (scheduleId: string) => {
    ...
    if (assignedDays.length === 0) {
      setError(
        'No days assigned to this schedule. Please refresh and try again.',
      );
      setIsUpdating(false);
      return;
    }
            ...
            {(enabledGroups.length > 0 || disabledGroups.length > 0) &&
              !isBasicMode && (
                ...
                >
                  ...
                  {enabledGroups.length + disabledGroups.length !== 1
                    ? 's'
                    : ''}
            ...
            >
              ...
              {disabledGroups.length > 0 && (
                <>
                  ...
                  >
                    These schedules are configured but not running. Toggle them
                    on to activate.
                  </Typography>
