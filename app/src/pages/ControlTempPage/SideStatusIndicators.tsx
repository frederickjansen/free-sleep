      ...
      >
        ...
        <Box
          sx={{
            ...
            height: 8,
            borderRadius: '50%',
            backgroundColor: leftIsOn ? '#4CAF50' : 'rgba(255, 255, 255, 0.3)',
            boxShadow: leftIsOn ? '0 0 8px rgba(76, 175, 80, 0.6)' : 'none',
      ...
      >
        ...
        <Box
          sx={{
            ...
            height: 8,
            borderRadius: '50%',
            backgroundColor: rightIsOn ? '#4CAF50' : 'rgba(255, 255, 255, 0.3)',
            boxShadow: rightIsOn ? '0 0 8px rgba(76, 175, 80, 0.6)' : 'none',
            transition: 'all 0.3s ease',
          }}
        />
      </Box>
