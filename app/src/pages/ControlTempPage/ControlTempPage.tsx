...
import AlarmDismissal from '@/pages/ControlTempPage/AlarmDismissal.tsx';
import AwayNotification from '@/pages/ControlTempPage/AwayNotification.tsx';
import { useControlTempStore } from '@/pages/ControlTempPage/controlTempStore.tsx';
import LinkToggle from '@/pages/ControlTempPage/LinkToggle.tsx';
import PowerButton from '@/pages/ControlTempPage/PowerButton.tsx';
import RoomClimate from '@/pages/ControlTempPage/RoomClimate.tsx';
import ScheduleStatusBar from '@/pages/ControlTempPage/ScheduleStatusBar.tsx';
import SideStatusIndicators from '@/pages/ControlTempPage/SideStatusIndicators.tsx';
import Slider from '@/pages/ControlTempPage/Slider.tsx';
import WaterNotification from '@/pages/ControlTempPage/WaterNotification.tsx';
import PrimeCompleteNotification from '@/pages/SettingsPage/PrimeCompleteNotification.tsx';
...
export default function ControlTempPage() {
  ...
  const { isUpdating, side, setIsUpdating, clearError, setError } =
    useAppStore();
  const [isDismissingPrimeNotification, setIsDismissingPrimeNotification] =
    useState(false);
  ...
  return (
    <PageContainer>
      ...
      >
        ...
        {schedules && (
          <ScheduleStatusBar schedules={schedules} currentDay={currentDay} />
        )}
        <LinkToggle />
        {settings.linkBothSides &&
          settings[side === 'right' ? 'left' : 'right'].awayMode && (
            <Alert severity="info">
              Lock is enabled, but the other side is in Away. Changes will only
              apply to this side until Away is turned off.
            </Alert>
          )}
