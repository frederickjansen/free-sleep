          ...
          >
            <Box sx={{ textAlign: 'center' }}>
              <Typography variant="body2" color="text.secondary">
                {latestReading.lux < 10
                  ? '🌙 Dark'
                  : latestReading.lux < 50
                    ? '🌆 Dim'
                    : latestReading.lux < 300
                      ? '💡 Indoor'
                      : latestReading.lux < 1000
                        ? '🏙️ Bright'
                        : '☀️ Very Bright'}
              </Typography>
...
const LuxSummaryCard = () => {
  ...
  return (
    <SectionCard
      ...
      subheader="Statistics for last 24 hours"
    >
      {isLoading ? (
        <Box sx={{ display: 'flex', justifyContent: 'center', py: 3 }}>
          <CircularProgress />
    ...
    <PageContainer sx={{ gap: 2 }}>
      ...
      <Paper sx={{ p: 2, mt: 2 }}>
        ...
        <Typography variant="body2" color="text.secondary" paragraph>
          Lux is a measure of illuminance, or the amount of light hitting a
          surface. The OPT4001 ambient light sensor measures light levels in
          your environment.
        </Typography>
